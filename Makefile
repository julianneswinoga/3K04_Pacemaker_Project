...
GCC_BIN = 
PROJECT = main
OBJECTS = main.o src/Pacemaker.o src/Communications.o src/Activity.o src/Pace.o src/Logging.o src/HeartMonitor.o src/FXOS8700Q/FXOS8700Q.o
